...
const REQUIRED_FIELDS: Record<string, string[]> = {
  ...
  session_config: [],
  turn_start: ["turn"],
  api_call_started: ["call_id", "agent", "mode"],
  api_call_finished: ["call_id", "agent", "mode", "status"],
  normalize_result: ["call_id", "agent", "mode", "fallback_path"],
  utterance_filter_result: ["call_id", "agent"],
