...
export { normalizeNegotiation } from "./negotiation.js";
export { normalizeVoting } from "./voting.js";
export { normalizeJudge } from "./judge.js";
export { normalizeDefense } from "./defense.js";
